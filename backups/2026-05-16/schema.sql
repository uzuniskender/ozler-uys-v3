...
\restrict or3ch0etTuzVGWfmc1CV5CNCl5RgwOy30JSIfQekVEZVUj2gAiwuPH9tqamtFS7
...
CREATE VIEW public.v_hammadde_tuketim AS
 SELECT (sh.tarih)::date AS tarih,
    ...
    (sum(sh.miktar))::bigint AS adet,
        CASE
            WHEN (max(m.hammadde_tipi) = ANY (ARRAY['SAC'::text, 'LEVHA'::text, 'PLY'::text])) THEN round((((sum(sh.miktar) * COALESCE(max(m.boy), (0)::numeric)) * COALESCE(max(m.en), (0)::numeric)) / 1000000.0), 3)
            ELSE round(((sum(sh.miktar) * COALESCE(max(m.uzunluk), (0)::numeric)) / 1000.0), 3)
        END AS toplam_metre,
    round(
        CASE
            WHEN (max(m.hammadde_tipi) = ANY (ARRAY['SAC'::text, 'LEVHA'::text, 'PLY'::text])) THEN ((((sum(sh.miktar) * COALESCE(max(m.boy), (0)::numeric)) * COALESCE(max(m.en), (0)::numeric)) / 1000000.0) * COALESCE(max(m.birim_kg_metre), (0)::numeric))
...
--
-- Name: idx_stok_hareketler_rezerv_order; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_stok_hareketler_rezerv_order ON public.uys_stok_hareketler USING btree (rezerv_order_id) WHERE (tip = 'rezerv'::text);
...
--
-- Name: uys_rapido_bom bom_select; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY bom_select ON public.uys_rapido_bom FOR SELECT TO authenticated USING (true);


--
-- Name: uys_bom_trees bom_tree_select; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY bom_tree_select ON public.uys_bom_trees FOR SELECT TO authenticated USING (true);


--
-- Name: uys_bom_trees bom_tree_write; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY bom_tree_write ON public.uys_bom_trees TO authenticated USING ((public.current_user_role() = ANY (ARRAY['admin'::text, 'planlama'::text]))) WITH CHECK ((public.current_user_role() = ANY (ARRAY['admin'::text, 'planlama'::text])));


--
-- Name: uys_rapido_bom bom_write; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY bom_write ON public.uys_rapido_bom TO authenticated USING ((public.current_user_role() = ANY (ARRAY['admin'::text, 'planlama'::text]))) WITH CHECK ((public.current_user_role() = ANY (ARRAY['admin'::text, 'planlama'::text])));
...
--
-- Name: uys_ie_hazirlama ie_haz_all; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY ie_haz_all ON public.uys_ie_hazirlama TO authenticated, anon USING (true) WITH CHECK (true);
...
--
-- Name: uys_ie_hazirlama ie_select; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY ie_select ON public.uys_ie_hazirlama FOR SELECT TO authenticated USING (true);


--
-- Name: uys_ie_hazirlama ie_write; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY ie_write ON public.uys_ie_hazirlama TO authenticated USING ((public.current_user_role() = ANY (ARRAY['admin'::text, 'planlama'::text]))) WITH CHECK ((public.current_user_role() = ANY (ARRAY['admin'::text, 'planlama'::text])));
...
--
-- Name: uys_rapido_bom rapido_bom_all; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY rapido_bom_all ON public.uys_rapido_bom TO authenticated, anon USING (true) WITH CHECK (true);


--
-- Name: uys_recipes recipe_select; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY recipe_select ON public.uys_recipes FOR SELECT TO authenticated USING (true);


--
-- Name: uys_recipes recipe_write; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY recipe_write ON public.uys_recipes TO authenticated USING ((public.current_user_role() = ANY (ARRAY['admin'::text, 'planlama'::text]))) WITH CHECK ((public.current_user_role() = ANY (ARRAY['admin'::text, 'planlama'::text])));
...
\unrestrict or3ch0etTuzVGWfmc1CV5CNCl5RgwOy30JSIfQekVEZVUj2gAiwuPH9tqamtFS7
