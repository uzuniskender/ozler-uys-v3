...
\restrict URKFG5znNNI5FrMbAsuEUWcXWbg9OuRqyoU9Si04kK7gJBZOBvGDzhRtwgDT5Mo
...
--
-- Name: uys_bom_trees allow_all; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY allow_all ON public.uys_bom_trees TO authenticated USING (true) WITH CHECK (true);
...
--
-- Name: uys_malzemeler allow_all; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY allow_all ON public.uys_malzemeler TO authenticated USING (true) WITH CHECK (true);
...
--
-- Name: uys_orders allow_all; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY allow_all ON public.uys_orders TO authenticated USING (true) WITH CHECK (true);
...
--
-- Name: uys_recipes allow_all; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY allow_all ON public.uys_recipes TO authenticated USING (true) WITH CHECK (true);
...
--
-- Name: uys_sevkler allow_all; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY allow_all ON public.uys_sevkler TO authenticated USING (true) WITH CHECK (true);
...
--
-- Name: uys_stok_hareketler allow_all; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY allow_all ON public.uys_stok_hareketler TO authenticated USING (true) WITH CHECK (true);
...
--
-- Name: uys_tedarikler allow_all; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY allow_all ON public.uys_tedarikler TO authenticated USING (true) WITH CHECK (true);
...
--
-- Name: uys_work_orders allow_all; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY allow_all ON public.uys_work_orders TO authenticated USING (true) WITH CHECK (true);
...
--
-- Name: uys_kullanicilar authenticated_only; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY authenticated_only ON public.uys_kullanicilar TO authenticated USING (true) WITH CHECK (true);


--
-- Name: uys_yetki_ayarlari authenticated_only; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY authenticated_only ON public.uys_yetki_ayarlari TO authenticated USING (true) WITH CHECK (true);
...
\unrestrict URKFG5znNNI5FrMbAsuEUWcXWbg9OuRqyoU9Si04kK7gJBZOBvGDzhRtwgDT5Mo
